 ...
 * Mon Mar 01 2021 12:31:05 GMT+0100 (hora estándar de Europa central)
...
changeVis(['GROUP', 'Materiales'], false);
changeVis(['GROUP', 'Lavabo Derecha'], false);
changeVis(['GROUP', 'Medidas'], false);
Visible = 'false';
Mueble = 'true';

eventHTMLElem('click', 'mueble', false, function(event) {
  if (Mueble == 'true') {
    changeVis(['GROUP', 'Mueble'], false);
    Mueble = 'false';
  } else {
    changeVis(['GROUP', 'Mueble'], true);
    Mueble = 'true';
  }
});

eventHTMLElem('click', 'medidas', false, function(event) {
  if (Visible == 'false') {
    changeVis(['GROUP', 'Medidas'], true);
    Visible = 'true';
    assignMat(['GROUP', 'Mueble'], 'Mueble Transparente');
  } else {
    changeVis(['GROUP', 'Medidas'], false);
    Visible = 'false';
    assignMat(['GROUP', 'Mueble'], 'Mueble');
  }
});

eventHTMLElem('click', 'izquierda', false, function(event) {
  changeVis(['GROUP', 'Lavabo Derecha'], false);
  changeVis(['GROUP', 'Lavabo Izquierda'], true);
});
eventHTMLElem('click', 'derecha', false, function(event) {
  changeVis(['GROUP', 'Lavabo Izquierda'], false);
  changeVis(['GROUP', 'Lavabo Derecha'], true);
});

eventHTMLElem('click', 'snap', false, function(event) {
  counter = 0;
  changeVis('Esfera Entorno', false);
});
counter = 2;
registerEveryFrame(function() {
  counter = (typeof counter == 'number' ? counter : 0) + 1;
  if (counter == 2) {
    getJSFunction('Pantallazo')(appInstance.renderer.domElement.toDataURL('image/png'));
    changeVis('Esfera Entorno', true);
  }
});
