...
registerSetTimeout(1, function() {
  ...
  '    var angle = data.angle.radian;' + '\n' +
  '    targetState.moveDirectionZ = -Math.cos(angle) * 2.5;' + '\n' +
  '    targetState.moveDirectionX = Math.sin(angle) * 1.5;' + '\n' +
  '});' + '\n' +
  '' + '\n' +
  'joystickRight.on(\'end\', function() {' + '\n' +
  '    targetState.moveDirectionZ = 0;' + '\n' +
  '    targetState.moveDirectionX = 0;' + '\n' +
  '});' + '\n' +
  '' + '\n' +
  '// 弹簧阻尼系统更新函数' + '\n' +
  ...
  '    currentState.moveDirectionX += (targetState.moveDirectionX - currentState.moveDirectionX) * springConfig.stiffness;' + '\n' +
  '    currentState.moveDirectionZ += (targetState.moveDirectionZ - currentState.moveDirectionZ) * springConfig.stiffness;' + '\n' +
  '    ' + '\n' +
  '    // 应用阻尼' + '\n' +
  '    currentState.moveX *= (1 - springConfig.damping);' + '\n' +
  '    currentState.moveY *= (1 - springConfig.damping);' + '\n' +
  '    currentState.moveDirectionX *= (1 - springConfig.damping);' + '\n' +
  '    currentState.moveDirectionZ *= (1 - springConfig.damping);' + '\n' +
  '    ' + '\n' +
  '    // 更新全局变量' + '\n' +
  '    window.moveX = currentState.moveX;' + '\n' +
  '    window.moveY = currentState.moveY;' + '\n' +
  '    window.moveDirectionX = currentState.moveDirectionX;' + '\n' +
  '    window.moveDirectionZ = currentState.moveDirectionZ;' + '\n' +
  '    ' + '\n' +
  '    // 继续下一帧更新' + '\n' +
