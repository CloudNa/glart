...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        getElements, retrieveObjectNames, AudioWebAudio, getObjectByName,
        bindListener, getSceneAnimFrameRate, getSceneByAction, getMaterialEditableValues,
        Tween, getObjectName, initObjectPicking, isObjectAmongObjects,
        getElement, transformCoordsSpace, getSceneCoordSystem, getMaterialEditableColors,
...
_initGlob.output.initOptions.preloaderProgressCb = function(percentage) {
  ...
  if (Math.round(_initGlob.percentage) < 30) {
    setHTMLElemAttribute('innerHTML', '加载模型...', 'loading_text', true);
  } else if (Math.round(_initGlob.percentage) < 90) {
    setHTMLElemAttribute('innerHTML', '准备场景...', 'loading_text', true);
  } else if (Math.round(_initGlob.percentage) >= 90) {
    setHTMLElemAttribute('innerHTML', '加载贴图...', 'loading_text', true);
    registerSetTimeout(2, function() {
      setHTMLElemAttribute('innerHTML', '编译材质...', 'loading_text', true);
      registerSetTimeout(2, function() {
        setHTMLElemAttribute('innerHTML', '请等待...', 'loading_text', true);
      });
    });
  }
})();
...
registerOnClick('trigger_seat_lock', false, false, [0,1,2], function() {
  ...
  operateAnimation('PLAY', 'trigger_seat_lock', 0, 99, 'LoopOnce', 1,
          function() {}, true);

      playSound(loadMedia_WebAudio('./sounds/seat_closing.mp3'), false);

  operateAnimation('PLAY', 'seat', 0, 99, 'LoopOnce', 1,
          function() {

    operateAnimation('PLAY', 'trigger_seat_unlock', 0, 99, 'LoopOnce', 1,
            function() {}, true);
...
registerOnClick('trigger_side_footboard', false, false, [0,1,2], function() {
  ...
  operateAnimation('PLAY', 'trigger_side_footboard', null, null, 'AUTO', 1,
    ...
    operateAnimation('PLAY', 'side_footboard', 0, 99, 'AUTO', 1,
            function() {
      side_footboard_moved = false;
    }, true);
...
registerOnClick('trigger_back_footboard', false, false, [0,1,2], function() {
  ...
  operateAnimation('PLAY', 'trigger_back_footboard', null, null, 'AUTO', 1,
    ...
    operateAnimation('PLAY', 'back_footboard', 0, 99, 'AUTO', 1,
            function() {
      back_footboard_moved = false;
    }, true);
