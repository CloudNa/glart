...
var VARS = Object.defineProperties({}, {
    'load script': { get: function() { return load_script; }, set: function(val) { load_script = val; } },
});
...
registerOnClick('<none>', false, false, [0,1,2], function() {
  load_script = 'js/DRACOLoader.js';
}, function() {});

Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('' + '\n' +
'    const dracoLoader = new v3d.DRACOLoader();' + '\n' +
'    dracoLoader.setDecoderPath(\'js/draco/\');' + '\n' +
'    app.loader.setDRACOLoader(dracoLoader);' + '\n' +
'')))(appInstance, v3d, PL, VARS, PROC);

appendScene('modle.glb', 'modle.glb', false, false, function() {}, function() {}, function() {});
